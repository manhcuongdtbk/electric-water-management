...
- [ ] AGENTS conventions reviewed (CONTRIBUTING §8): i18n via `t(...)`, no abbreviations outside `docs/THUAT_NGU.md`, BigDecimal for money/electricity, all-role test coverage (see `V2_HANH_VI_HE_THONG.md` mục 1 for the canonical role list).
