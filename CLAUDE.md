...
- Pre-M4 Việc #1 + #2: ✅ DONE — F06 bug fix (PR #24) + nested auth audit (PR #25) + ContactPoints existence-enum fix (PR #26). Baseline hiện tại: **568 specs**
- M4 (7/5–16/5): ← TIẾP THEO — Báo cáo F12 tổng hợp + F13 tra cứu lịch sử + F14 xuất CSV
