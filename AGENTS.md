...
3. `docs/V2_HANH_VI_HE_THONG.md` — hành vi runtime: vai trò, trạng thái kỳ, dữ liệu xuyên kỳ, nguyên tắc `.kept`/`.with_discarded`. **Đọc mục 7 trước khi dùng `.kept` trong query.**
