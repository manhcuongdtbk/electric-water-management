...
Hệ thống quản lý điện nội bộ Sư đoàn thay thế các file Excel tính tiền điện hiện tại, phục vụ việc:
...
- Khối và nhóm chỉ phục vụ hiển thị đầu mối sinh hoạt trên bảng tính tiền, không ảnh hưởng tính toán. Đầu mối công cộng không nằm trong khối/nhóm.
...
**Đơn vị quản lý khu vực:** Trong mỗi khu vực, 1 đơn vị trong khu vực đó được chỉ định làm đơn vị quản lý khu vực. Quản trị viên của đơn vị đó, ngoài việc nhập liệu cho đơn vị mình, còn được ủy quyền nhập liệu phần chia sẻ của khu vực: công tơ tổng, đầu mối sinh hoạt thuộc khu vực, đầu mối công cộng thuộc khu vực, đầu mối bơm nước (nhập liệu chỉ số công tơ, không bao gồm cấu hình phân bổ), đầu mối ngoài biên chế (bao gồm quân số). Quản trị viên đơn vị quản lý khu vực không quản lý được các đơn vị khác trong cùng khu vực — chỉ quản lý phần chia sẻ của khu vực và đơn vị mình. Quản trị viên hệ thống vẫn giữ toàn quyền can thiệp khi cần.
...
- **Đầu mối sinh hoạt:** Có người trong biên chế, có công tơ sinh hoạt, có tiêu chuẩn điện, có sử dụng điện sinh hoạt, có dòng trong bảng tính tiền. Thuộc đơn vị hoặc khu vực. Đầu mối sinh hoạt thuộc khu vực do quản trị viên hệ thống quản lý, có thể ủy quyền cho đơn vị quản lý khu vực nhập liệu.
- **Đầu mối công cộng:** Không có người, có công tơ công cộng, không có tiêu chuẩn, không có dòng trong bảng tính tiền. Sử dụng điện công cộng tham gia vào tính tổn hao toàn khu vực. Thuộc đơn vị hoặc khu vực. Đầu mối công cộng thuộc đơn vị do quản trị viên đơn vị khai báo. Đầu mối công cộng thuộc khu vực do quản trị viên hệ thống quản lý.
- **Đầu mối bơm nước (trạm bơm):** Không có người, có công tơ bơm nước, không có dòng trong bảng tính tiền. Điện bơm nước được phân bổ cho các đối tượng sử dụng (chi tiết ở mục 9). Luôn thuộc khu vực.
- **Đầu mối ngoài biên chế:** Có người nhưng không nằm trong biên chế, không có công tơ, không có dòng trong bảng tính tiền. Người ngoài biên chế khi dùng điện thì dùng theo công tơ sinh hoạt hoặc công cộng hiện có. Tuy nhiên, đầu mối ngoài biên chế được phân bổ điện bơm nước. Luôn thuộc khu vực.
...
- Quản trị viên đơn vị quản lý khu vực xem bảng tính tiền của đơn vị mình, bao gồm cả các đầu mối sinh hoạt thuộc khu vực (vì đơn vị quản lý khu vực được ủy quyền nhập liệu cho phần khu vực).
...
Điện bơm nước từ các trạm bơm trong khu vực được phân bổ cho các đối tượng sử dụng. Phân bổ bơm nước do quản trị viên hệ thống quản lý.
...
3 loại đối tượng có thể nhận phân bổ bơm nước:
...
Quản trị viên hệ thống quyết định đối tượng nào nhận phân bổ và cách nhận, bằng cách nhập số phần trăm hoặc hệ số (hệ thống tự nhân với quân số) cho từng đối tượng.
...
| Khác | Số cụ thể cho đầu mối đó, hoặc hệ số × số người của đầu mối đó. Quản trị viên chọn dạng nhập (số cụ thể hoặc hệ số) cho từng đầu mối. Dạng hệ số: hệ thống tự tính khoản trừ = hệ số × quân số đầu mối | Quản trị viên đơn vị |
...
4 vai trò trong hệ thống (quản trị viên đơn vị quản lý khu vực không phải vai trò riêng mà là quản trị viên đơn vị được ủy quyền thêm). Nguyên tắc chính: quản trị viên hệ thống quản lý tất cả, quản trị viên đơn vị quản lý khu vực quản lý khu vực và đơn vị mình, quản trị viên đơn vị quản lý đơn vị mình, chỉ huy đơn vị chỉ xem đơn vị mình.
...
- Quản lý tất cả. Mọi thứ quản trị viên đơn vị làm được, quản trị viên hệ thống đều làm được, trên tất cả các đơn vị và khu vực.
- Thiết lập ban đầu: tạo khu vực, tạo đơn vị, chỉ định đơn vị quản lý khu vực.
...
- Quản lý phân bổ bơm nước.
- Quản lý đầu mối thuộc khu vực (sinh hoạt, công cộng, bơm nước, ngoài biên chế).
- Mở/đóng kỳ tính toán, mở lại kỳ cũ khi có sai sót.
- Quản lý tài khoản: quản trị viên hệ thống, quản trị viên đơn vị, chỉ huy đơn vị (không quản lý tài khoản kỹ thuật viên).
- Xem nhật ký hệ thống.
...
- Nếu là đơn vị quản lý khu vực: thêm quyền nhập liệu phần khu vực (công tơ tổng, đầu mối thuộc khu vực), nhưng không quản lý được các đơn vị khác trong cùng khu vực.
...
- Quản trị viên hệ thống có thể mở lại kỳ cũ khi có sai sót nhập liệu. Nếu có kỳ đang mở thì phải đóng kỳ đó trước (hiển thị cảnh báo). Nếu không có kỳ nào đang mở thì mở trực tiếp. Khi đóng kỳ cũ sau khi sửa, nếu số cuối kỳ của kỳ đó khác số đầu kỳ của kỳ kế tiếp, hệ thống hiển thị cảnh báo (chỉ cảnh báo, không tự động sửa kỳ kế tiếp — đúng nguyên tắc kỳ này không ảnh hưởng kỳ khác).
...
flowchart TD
    ...
    S8["Bước 8 (Quản trị viên hệ thống): Cấu hình khu vực\n- Đầu mối bơm nước + công tơ\n- Đầu mối sinh hoạt thuộc khu vực\n- Đầu mối công cộng thuộc khu vực\n- Đầu mối ngoài biên chế\n- Phân bổ bơm nước\n- Điều chỉnh cấu hình chung nếu cần"]
...
| Đầu mối bơm nước | Tên, khu vực (nếu quản trị viên hệ thống tạo), ít nhất 1 công tơ (tên) | Đánh dấu không tổn hao cho công tơ (mặc định: có tổn hao) |
| Đầu mối ngoài biên chế | Tên, khu vực (nếu quản trị viên hệ thống tạo), quân số (≥ 1, 1 con số tổng, không phân theo nhóm cấp bậc) | — |
...
| Tài khoản người dùng | Tên đăng nhập, mật khẩu, tên hiển thị, vai trò. Nếu vai trò là quản trị viên đơn vị hoặc chỉ huy đơn vị: đơn vị thuộc về (required) | — |
...
| Xóa đơn vị quản lý khu vực | Có (cảnh báo) | Hiển thị cảnh báo. Nếu vẫn xóa, quản trị viên hệ thống tự quản lý khu vực cho đến khi chỉ định đơn vị khác. |
| Xóa khối đang có nhóm/đầu mối | Có | Nhóm/đầu mối bên trong chuyển thành trực tiếp thuộc đơn vị. Khối chỉ là hiển thị. |
...
| Đổi đơn vị quản lý khu vực sang đơn vị khác | Có | Chuyển quyền nhập liệu khu vực sang đơn vị khác trong cùng khu vực. |
| Di chuyển đầu mối giữa các khối/nhóm | Có | Chỉ thay đổi hiển thị, không ảnh hưởng tính toán. |
...
- Đơn giá điện.
- Quân số theo nhóm cấp bậc của từng đầu mối.
...
- **Xóa đơn vị quản lý khu vực:** hiển thị cảnh báo. Nếu vẫn xóa, quản trị viên hệ thống tự quản lý khu vực cho đến khi chỉ định đơn vị khác.
