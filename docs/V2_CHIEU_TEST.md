...
Mỗi test case = input + expected output. Không chỉ verify "thành công" mà phải verify: data DB đúng, redirect đúng, flash đúng, form state đúng, cascade đúng, data per kỳ đúng.
