...
| Sidebar | Đúng items per role (chiều 3 bảng quyền). TECH: 3 items. SA: 17 items. CMD: 6 items. UA-ZM: 12 items | CMD thấy "Chỉ số đầu mối" trong sidebar = bug (sidebar ẩn, nhưng truy cập trực tiếp vẫn xem được) |
