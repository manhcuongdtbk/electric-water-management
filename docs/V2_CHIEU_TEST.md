...
> Chiều/giá trị test đích cho 3 tính năng 1.2.0. **Trạng thái:** cột "Khác" hệ số đơn vị (TN1) và hiển thị chi tiết tổn hao (TN3) **đã triển khai** (merge vào `develop`); phân bổ bơm theo trạm (TN2) **chưa**. Danh sách đầy đủ ở từng spec; phần này chốt chiều mới để spec test bám theo.
>
...
### Phân bổ bơm theo trạm — mở rộng chiều "phân bổ bơm nước" + giao điểm Kỳ (chưa triển khai)
