# 02. Bảng thuật ngữ / Glossary — v1.4.0
...
| F# | Tiếng Việt | English | Roles | Mô tả ngắn |
|---|---|---|---|---|
| F15 | Quản lý tài khoản | User management | tech, admin_level1 | Tạo, khóa, mở khóa tài khoản. Gán role + đơn vị |
| F16 | Đăng nhập | Authentication | Tất cả | Đăng nhập bằng email + mật khẩu. Bắt buộc đổi mật khẩu lần đầu (custom flag `force_password_change`) |
| F17 | Khóa tài khoản | Account lockout | Tự động | Devise khóa sau 5 lần nhập sai mật khẩu liên tiếp |
| F18 | Tự động đăng xuất khi không thao tác | Session timeout | Tự động | Devise Timeoutable — sau 2 giờ không thao tác, phiên đăng nhập hết hạn |
...
| `force_password_change` | Bắt buộc đổi mật khẩu lần đầu (thuộc F16) | 8.5 |
...
| `Meter` | Công tơ | 2 |
| `meter_type` | Loại công tơ: `normal`, `public_meter`, `pump_station`, `no_loss` | 2 |
...
| v1.4.0 | 05/05/2026 | Sửa F-number mapping F16/F18 cho khớp SCOPE_DOCUMENT_v3_0_3 (khách duyệt). F16 bao gồm force password change. F18 = Timeoutable. Xóa ghi chú "no_loss chưa implement". Thêm admin_level1 vào F15 roles. |
