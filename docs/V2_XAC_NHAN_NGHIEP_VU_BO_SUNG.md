...
> **Phiên bản:** 2.1.2
> **Ngày:** 11/06/2026
> **Bối cảnh:** Quản trị viên hệ thống kiểm thử trên môi trường Acceptance kỳ 4/2026 và đưa ra 3 mong muốn mới.
...
Ngày 26/05/2026, đội phát triển đã kiểm tra toàn bộ bảng tính tiền kỳ 4/2026 trên môi trường Acceptance bằng cách **tính tay từng bước** và so sánh với kết quả hệ thống xuất ra. Kết quả: **tất cả số liệu khớp chính xác**.
...
- Mục Bối cảnh và mục 1: thay "staging" bằng tên môi trường canonical "Acceptance" và "test" bằng "kiểm thử" cho khớp quy ước đặt tên môi trường (AGENTS.md) và dễ hiểu với khách.
