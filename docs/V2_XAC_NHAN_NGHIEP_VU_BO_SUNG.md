...
Ngày 30/05/2026, đội phát triển đã kiểm tra toàn bộ bảng tính tiền kỳ 4/2026 trên staging bằng cách **tính tay từng bước** và so sánh với kết quả hệ thống xuất ra. Kết quả: **tất cả số liệu khớp chính xác**.
...
Trong 1 khu vực có nhiều trạm bơm nước. Mỗi trạm bơm phục vụ 1 vùng nhà khác nhau trong khu vực:

- Trạm bơm 1 bơm nước cho vùng nhà A (ví dụ: Khối 1).
- Trạm bơm 2 bơm nước cho vùng nhà B (ví dụ: Khối 2).
...
Dưới đây là 4 câu hỏi. Mỗi câu có **đề xuất** (in đậm) — nếu đồng ý thì đội phát triển làm theo đề xuất luôn, không cần giải thích thêm.
...
→ **Đề xuất: xác nhận hệ thống đang đúng.** Nếu còn phát hiện vấn đề gì thì báo thêm.
...
→ **Đề xuất: thêm tính năng này.** Nếu không cần thì vẫn dùng được cách nhập "Số cụ thể" hiện tại (nhưng phải tự tính tay khi quân số thay đổi).
...
→ **Đề xuất: thêm cả 3 loại.** Nếu thực tế chỉ cần 1-2 loại thì cho biết cần loại nào nhé.
