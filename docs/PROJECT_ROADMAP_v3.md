# Lộ trình triển khai (nội bộ) — v3.0

> File này chỉ dành cho mình. Scope nghiệp vụ, danh sách chức năng, thanh toán, bảo hành → xem **SCOPE_DOCUMENT_v3.html**
...
| | |
|---|---|
| **Timeline** | 14/4 – 25/5/2026 (~6 tuần, có buffer) |
...
| **Scope** | 21 chức năng (F01–F21) + sao lưu/phục hồi (không có F#), xem chi tiết trong SCOPE_DOCUMENT_v3.html |
...
- **Devise** — xác thực tiêu chuẩn ngành, battle-tested. Module Lockable (F17 — khóa sau 5 lần sai), Timeoutable (F18 — tự đăng xuất 30 phút), Trackable có sẵn. Quan trọng: tài liệu bảo mật gửi khách quân đội có trọng lượng hơn so với tự code authentication.
...
### Nghiệp vụ đã xác nhận hoàn tất (06/04/2026)

Toàn bộ nghiệp vụ tính toán đã được anh Thảo xác nhận. Không còn mục nào chờ confirm về mặt nghiệp vụ. Chi tiết xem XAC_NHAN_NGHIEP_VU_v5.html hoặc SCOPE_DOCUMENT_v3.html.
...
```
Tuần     14/4    21/4    28/4    5/5     12/5    19/5    25/5
         ├───────┼───────┼───────┼───────┼───────┼───────┤
M1       ████████████████░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░  Nền tảng
M2       ░░░░░░░░████████████████████░░░░░░░░░░░░░░░░░░░░  Nghiệp vụ
M3       ░░░░░░░░░░░░░░░░░░░░████████████░░░░░░░░░░░░░░░  Phân quyền
...
- [ ] Schema chính:
  ...
  - `meters` (công tơ) — thuộc đầu mối, có flag: thường / công cộng / trạm bơm nước
...
- [ ] F02: Khai báo công tơ trong mỗi đầu mối — CRUD, thuộc đầu mối. Flag: thường / công cộng / trạm bơm nước. Công tơ công cộng không xuất hiện trong bản thu tiền
- [ ] F03: Khai báo quân số theo 7 nhóm cấp bậc — theo đầu mối. Phần mềm tự tính tiêu chuẩn
- [ ] F04: Cấu hình tỷ lệ và cột "Khác" — tiết kiệm 5–10% (cấp 1), công cộng Sư đoàn 5–10% (cấp 1), công cộng đơn vị 10–20% (đơn vị tự cấu hình), cột "Khác" (nhập số hoặc hệ số × số người). Tổn hao: phần mềm tự tính, không cần khai báo
- [ ] i18n tiếng Việt
...
- [ ] F08: Tính toán tiêu chuẩn theo nghị định 02 — tiêu chuẩn = tổng(số người × định mức kW) + (tổng quân số × 9,45 kW bơm nước). Trừ 4 khoản: tiết kiệm (%), tổn hao (phân bổ theo tỷ lệ kW), công cộng (2 cấp: Sư đoàn + đơn vị), khác. Tổn hao nằm trong "Số phải trừ" (trừ khỏi tiêu chuẩn). Kết quả: "tiêu chuẩn còn lại"
...
- [ ] F18: Tự động đăng xuất khi không thao tác — Devise Timeoutable, sau 30 phút
...
| F# | Tên (đúng SCOPE_DOCUMENT_v3) | Milestone | Ghi chú |
|----|------|-----------|---------|
...
| F18 | Tự động đăng xuất khi không thao tác | M3 | Sau 30 phút |
