...
![Đổi mật khẩu](images/49_doi_mat_khau.png)
...
- Vào trang **Nhập số điện lực**, nhập số sử dụng công tơ tổng (xem hình dưới).
...
![Nhập số điện lực — Quản trị viên hệ thống](images/05_nhap_so_dien_luc_sa.png)

![Nhập số điện lực — Quản trị viên đơn vị quản lý khu vực](images/31_nhap_so_dien_luc_ua_zm.png)

![Nhập số điện lực — Chỉ huy đơn vị quản lý khu vực (chỉ xem)](images/61_nhap_so_dien_luc_cmd_zm.png)
...
![Chỉ số đầu mối — Chỉ huy đơn vị quản lý khu vực (chỉ xem)](images/42_chi_so_dau_moi_cmd_zm.png)

![Chỉ số đầu mối — Chỉ huy đơn vị (chỉ xem)](images/69_chi_so_dau_moi_cmd.png)
...
![Chỉ số bơm nước — Quản trị viên hệ thống](images/07_chi_so_bom_nuoc_sa.png)

![Chỉ số bơm nước — Quản trị viên đơn vị quản lý khu vực](images/30_chi_so_bom_nuoc_ua_zm.png)

![Chỉ số bơm nước — Chỉ huy đơn vị quản lý khu vực (chỉ xem)](images/62_chi_so_bom_nuoc_cmd_zm.png)
...
![Tổng quan — Quản trị viên đơn vị quản lý khu vực](images/27_tong_quan_ua_zm.png)

![Tổng quan — Quản trị viên đơn vị](images/36_tong_quan_ua.png)

![Tổng quan — Chỉ huy đơn vị quản lý khu vực](images/40_tong_quan_cmd_zm.png)

![Tổng quan — Chỉ huy đơn vị](images/44_tong_quan_cmd.png)
...
![Bảng tính tiền — Quản trị viên đơn vị quản lý khu vực](images/28_bang_tinh_tien_ua_zm.png)

![Bảng tính tiền — Quản trị viên đơn vị](images/37_bang_tinh_tien_ua.png)

![Bảng tính tiền — Chỉ huy đơn vị quản lý khu vực](images/41_bang_tinh_tien_cmd_zm.png)

![Bảng tính tiền — Chỉ huy đơn vị](images/45_bang_tinh_tien_cmd.png)
...
![Tra cứu lịch sử — Quản trị viên hệ thống](images/04_tra_cuu_lich_su_sa.png)

![Tra cứu lịch sử — so sánh 2 kỳ](images/50_tra_cuu_lich_su_so_sanh_sa.png)

![Tra cứu lịch sử — Quản trị viên đơn vị quản lý khu vực](images/53_tra_cuu_lich_su_ua_zm.png)

![Tra cứu lịch sử — Quản trị viên đơn vị](images/56_tra_cuu_lich_su_ua.png)

![Tra cứu lịch sử — Chỉ huy đơn vị quản lý khu vực](images/60_tra_cuu_lich_su_cmd_zm.png)

![Tra cứu lịch sử — Chỉ huy đơn vị](images/68_tra_cuu_lich_su_cmd.png)
...
![Bảng tính tiền — nút Xuất Excel](images/51_bang_tinh_tien_xuat_excel.png)
...
![Đầu mối — Danh sách](images/08_dau_moi_danh_sach_sa.png)
...
Đầu mối sinh hoạt và công cộng có thể thuộc đơn vị hoặc khu vực. Quản trị viên hệ thống và quản trị viên đơn vị quản lý khu vực thấy ô chọn "Thuộc đơn vị" hoặc "Thuộc khu vực" trên biểu mẫu. Quản trị viên đơn vị (không quản lý khu vực) tạo đầu mối thì mặc định thuộc đơn vị mình, không cần chọn.

![Tạo đầu mối sinh hoạt — Quản trị viên hệ thống](images/09_dau_moi_tao_sinh_hoat.png)
...
![Sửa đầu mối](images/13_dau_moi_sua.png)
...
![Đầu mối — Quản trị viên đơn vị quản lý khu vực](images/32_dau_moi_ua_zm.png)

![Đầu mối — Quản trị viên đơn vị](images/39_dau_moi_ua.png)

![Đầu mối — Chỉ huy đơn vị quản lý khu vực (chỉ xem)](images/63_dau_moi_cmd_zm.png)

![Đầu mối — Chỉ huy đơn vị (chỉ xem)](images/70_dau_moi_cmd.png)
...
![Khối — Quản trị viên hệ thống](images/14_khoi_danh_sach.png)

![Khối — Quản trị viên đơn vị quản lý khu vực](images/54_khoi_ua_zm.png)

![Khối — Quản trị viên đơn vị](images/57_khoi_ua.png)

![Khối — Chỉ huy đơn vị quản lý khu vực (chỉ xem)](images/64_khoi_cmd_zm.png)

![Khối — Chỉ huy đơn vị (chỉ xem)](images/71_khoi_cmd.png)

![Nhóm — Quản trị viên hệ thống](images/15_nhom_danh_sach.png)

![Nhóm — Quản trị viên đơn vị quản lý khu vực](images/55_nhom_ua_zm.png)

![Nhóm — Quản trị viên đơn vị](images/58_nhom_ua.png)

![Nhóm — Chỉ huy đơn vị quản lý khu vực (chỉ xem)](images/65_nhom_cmd_zm.png)

![Nhóm — Chỉ huy đơn vị (chỉ xem)](images/72_nhom_cmd.png)
...
![Cấu hình đơn vị — Quản trị viên hệ thống](images/16_cau_hinh_don_vi_sa.png)

![Cấu hình đơn vị — Quản trị viên đơn vị quản lý khu vực](images/33_cau_hinh_don_vi_ua_zm.png)

![Cấu hình đơn vị — Quản trị viên đơn vị](images/59_cau_hinh_don_vi_ua.png)

![Cấu hình đơn vị — Chỉ huy đơn vị quản lý khu vực (chỉ xem)](images/43_cau_hinh_don_vi_cmd.png)

![Cấu hình đơn vị — Chỉ huy đơn vị (chỉ xem)](images/73_cau_hinh_don_vi_cmd_regular.png)
...
![Khu vực — Danh sách](images/17_khu_vuc_danh_sach.png)

**Tạo khu vực:** Nhập tên khu vực + tên công tơ tổng. Khu vực mới chưa có đơn vị nào.

![Tạo khu vực mới](images/18_khu_vuc_tao_moi.png)
...
![Khu vực — Quản trị viên đơn vị quản lý khu vực (chỉ đọc)](images/35_khu_vuc_ua_zm.png)

![Khu vực — Chỉ huy đơn vị quản lý khu vực (chỉ đọc)](images/66_khu_vuc_cmd_zm.png)

### F5. Đơn vị

Trang **Đơn vị** (chỉ quản trị viên hệ thống) quản lý đơn vị.

![Đơn vị — Danh sách](images/20_don_vi_danh_sach.png)
...
![Phân bổ bơm nước — Quản trị viên đơn vị quản lý khu vực](images/34_phan_bo_bom_nuoc_ua_zm.png)

![Phân bổ bơm nước — Chỉ huy đơn vị quản lý khu vực (chỉ xem)](images/67_phan_bo_bom_nuoc_cmd_zm.png)
...
![Đơn giá điện và kỳ tính toán](images/22_don_gia_dien.png)
...
![Nhóm cấp bậc](images/23_nhom_cap_bac.png)
...
![Tài khoản — Danh sách (quản trị viên hệ thống)](images/24_tai_khoan_danh_sach.png)

![Tài khoản — Danh sách (kỹ thuật viên)](images/46_tai_khoan_tech.png)
...
![Tạo tài khoản](images/25_tai_khoan_tao_moi.png)
...
![Nhật ký hoạt động — Quản trị viên hệ thống](images/26_nhat_ky_sa.png)

![Nhật ký hoạt động — Kỹ thuật viên](images/48_nhat_ky_tech.png)

### G3. Sao lưu dữ liệu

![Sao lưu dữ liệu](images/47_sao_luu_tech.png)
