...
![Trang đăng nhập](hdsd/images/01_dang_nhap.png)
...
![Đổi mật khẩu lần đầu](hdsd/images/74_doi_mat_khau_lan_dau.png)
...
![Tự đổi mật khẩu](hdsd/images/49_doi_mat_khau.png)
...
![Nhập số điện lực — Quản trị viên đơn vị quản lý khu vực](hdsd/images/31_nhap_so_dien_luc_ua_zm.png)
...
![Chỉ số đầu mối — Quản trị viên đơn vị](hdsd/images/38_chi_so_dau_moi_ua.png)

Quản trị viên hệ thống thấy thêm ô lọc khu vực/đơn vị và cột Khu vực, Đơn vị:

![Chỉ số đầu mối — Quản trị viên hệ thống](hdsd/images/06_chi_so_dau_moi_sa.png)
...
![Chỉ số bơm nước — Quản trị viên đơn vị quản lý khu vực](hdsd/images/30_chi_so_bom_nuoc_ua_zm.png)
...
![Tổng quan — Quản trị viên hệ thống](hdsd/images/02_tong_quan_sa.png)
...
![Tổng quan — Quản trị viên đơn vị](hdsd/images/36_tong_quan_ua.png)
...
![Bảng tính tiền — Quản trị viên hệ thống](hdsd/images/03_bang_tinh_tien_sa.png)

Chỉ huy đơn vị thấy bảng tính tiền ở chế độ chỉ xem (không có nút Tính toán lại):

![Bảng tính tiền — Chỉ huy đơn vị (chỉ xem)](hdsd/images/45_bang_tinh_tien_cmd.png)
...
![Tra cứu lịch sử — So sánh 2 kỳ](hdsd/images/04_tra_cuu_lich_su_sa.png)
...
![Tra cứu lịch sử — Theo khoảng thời gian](hdsd/images/75_tra_cuu_theo_khoang_thoi_gian.png)
...
![Đầu mối — Quản trị viên đơn vị](hdsd/images/39_dau_moi_ua.png)
...
![Tạo đầu mối sinh hoạt](hdsd/images/09_dau_moi_tao_sinh_hoat.png)

- **Công cộng:** Tên, thuộc đơn vị hoặc khu vực, ít nhất 1 công tơ.

![Tạo đầu mối công cộng](hdsd/images/10_dau_moi_tao_cong_cong.png)

- **Bơm nước:** Tên, khu vực, ít nhất 1 công tơ.

![Tạo đầu mối bơm nước](hdsd/images/11_dau_moi_tao_bom_nuoc.png)

- **Ngoài biên chế:** Tên, khu vực, quân số (≥ 1, 1 con số tổng).

![Tạo đầu mối ngoài biên chế](hdsd/images/12_dau_moi_tao_ngoai_bien_che.png)
...
![Tạo đầu mối sinh hoạt — Quản trị viên đơn vị quản lý khu vực (có ô chọn Đơn vị/Khu vực)](hdsd/images/52_dau_moi_tao_sinh_hoat_ua_zm.png)
...
![Cấu hình đơn vị — Quản trị viên đơn vị](hdsd/images/59_cau_hinh_don_vi_ua.png)
...
![Đơn vị — Quản trị viên hệ thống](hdsd/images/20_don_vi_danh_sach.png)

**Tạo đơn vị:** Nhập tên, chọn khu vực thuộc về. Lưu ý: không đổi được khu vực sau khi tạo.

![Tạo đơn vị](hdsd/images/76_don_vi_tao_moi.png)
...
![Phân bổ bơm nước — cột "% Cố định" và cột "Hệ số" thể hiện 2 cách phân bổ](hdsd/images/21_phan_bo_bom_nuoc_sa.png)
...
![Đơn giá điện và kỳ tính toán — Quản trị viên hệ thống](hdsd/images/22_don_gia_dien.png)
...
![Nhóm cấp bậc — Quản trị viên hệ thống](hdsd/images/23_nhom_cap_bac.png)
...
![Tài khoản — Quản trị viên hệ thống](hdsd/images/24_tai_khoan_danh_sach.png)
...
![Nhật ký hoạt động — Quản trị viên hệ thống](hdsd/images/77_nhat_ky_hoat_dong.png)

### G3. Sao lưu dữ liệu

![Sao lưu dữ liệu — Kỹ thuật viên](hdsd/images/47_sao_luu_tech.png)
