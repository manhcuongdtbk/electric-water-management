...
![Khối — Danh sách](images/14_khoi_danh_sach.png)

![Nhóm — Danh sách](images/15_nhom_danh_sach.png)
...
![Cấu hình đơn vị — Chỉ huy đơn vị (chỉ xem)](images/43_cau_hinh_don_vi_cmd.png)
