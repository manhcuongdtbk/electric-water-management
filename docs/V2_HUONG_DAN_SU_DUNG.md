...
![Nhập số điện lực](images/05_nhap_so_dien_luc_sa.png)
...
![Cấu hình đơn vị](images/16_cau_hinh_don_vi_sa.png)
...
![Phân bổ bơm nước](images/21_phan_bo_bom_nuoc_sa.png)
...
![Tài khoản — Danh sách](images/24_tai_khoan_danh_sach.png)
...
- Chèn 15 ảnh đại diện vào các mục: B1 (đăng nhập), D bước 3 (nhập số điện lực), D1 (chỉ số đầu mối), D2 (chỉ số bơm nước), E1 (tổng quan SA + UA), E2 (bảng tính tiền), E3 (tra cứu lịch sử), F1 (đầu mối danh sách + tạo mới), F3 (cấu hình đơn vị), F4 (khu vực), F6 (phân bổ bơm nước), F7 (đơn giá điện), F8 (nhóm cấp bậc), G1 (tài khoản), G3 (sao lưu).
- 33 ảnh còn lại (các vai trò khác nhau trên cùng trang) nằm trong `docs/images/` để tham khảo, chưa chèn vào văn bản.
