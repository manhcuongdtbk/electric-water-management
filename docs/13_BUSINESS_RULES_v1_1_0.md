...
- **Nghiệp vụ:** khi thu mỗi người % công cộng, tiền đó dùng để trả cho các vị trí điện công cộng (hội trường, trường bắn, đèn đường...). Vì vậy công tơ "công cộng" (`public_meter`) **không xuất hiện trong bản thu tiền**.
