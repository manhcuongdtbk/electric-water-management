...
**Bước 2 — Phân bổ bơm nước:** Tổng điện bơm nước toàn khu vực (sử dụng thô + tổn hao) được phân bổ cho các đối tượng (đơn vị, đầu mối sinh hoạt thuộc khu vực, đầu mối ngoài biên chế) theo cấu hình do quản trị viên hệ thống hoặc đơn vị quản lý khu vực thiết lập. Có 2 cách phân bổ: phần trăm cố định hoặc hệ số nhân quân số.
...
Lần đầu đăng nhập, hệ thống bắt buộc đổi mật khẩu. Nhập mật khẩu mới theo yêu cầu: tối thiểu 8 ký tự, có ít nhất 1 chữ hoa, 1 chữ thường, 1 số, 1 ký tự đặc biệt. Sau khi đổi thành công, hệ thống chuyển về trang Tổng quan.
...
**Gộp dọc:** Các dòng cùng khu vực/đơn vị/khối/nhóm liên tiếp được gộp thành 1 ô gộp dọc.
...
- **Cột Khác** từng đầu mối sinh hoạt: giá trị bổ sung trừ hoặc cộng vào tiêu chuẩn. Có 2 dạng nhập:
  ...
  - **Hệ số:** Nhập hệ số, hệ thống tự tính = hệ số × quân số đầu mối.
