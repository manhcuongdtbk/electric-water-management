...
**Cải tiến optional (chưa làm — YAGNI cho quy mô hiện tại):** template ADR/PR/issue; cheat-sheet đầu AGENTS.md; checklist onboarding; lint định dạng ADR trong CI; DORA metrics; tách ADR ra `docs/adr/`.
