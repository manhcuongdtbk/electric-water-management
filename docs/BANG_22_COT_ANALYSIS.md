...
**Vị trí không tổn hao** (Sheet1, row 5-8):

Một số công tơ đặt TẠI trạm biến áp, không có đường dây nối từ công tơ tổng
→ không phát sinh tổn hao đường dây.
Tháng 02: Tiểu đoàn 18 = 4,020 kW (Sheet1 row 7).

**Công thức tổn hao tổng**:
```
Số điện lực thô                             = 45,960 kW (Sheet1 row 9)
Trừ vị trí không tổn hao                    = 4,020 kW  (Sheet1 row 7-8)
Số sử dụng sau trừ (A)                      = 41,940 kW (Sheet1 row 10)
Tổng công tơ có tổn hao (B)                 = 40,188 kW (Sheet1 row 153/155)
Tổn hao tổng (C = A − B)                    = 1,752 kW  (Sheet1 row 157)
```

**Phân bổ tổn hao cho từng công tơ**:
```
Tổn hao công tơ X = C × (kW sử dụng công tơ X ÷ B)
```
Chỉ phân bổ cho các công tơ TRONG bảng tổn hao (40,188 kW).
Công tơ "tại trạm" (không tổn hao) nhận tổn hao = 0.
...
| 5 | Ban Tác Huấn (Trưởng ban + Quý) | — | 2 | — | — | 76 | 12.6 | 4.43 | 8.86 | 4 | 71.31 |
...
> **Lưu ý cột M (Khác)**: Có 62 dòng có giá trị M khác 0 trong Excel. Đặc biệt, row 42 (Bảo đảm) có M = −296 (giá trị âm, trừ phần quân y). Engine cần xử lý cột "Khác" có thể âm.
...
### 5.3 CÔNG CỘNG — Excel chỉ có 1 cấp, v5 có 2 cấp

| | Excel tháng 02 | Nghiệp vụ v5 (ĐÚNG) |
|---|---|---|
| **Cấp** | **1 cấp**: Công cộng Sư đoàn 10% | **2 cấp**: CC Sư đoàn + CC đơn vị |
| **Cột** | L = (I+J) × 10% | 2 cột riêng trong "Số phải trừ" |
...
| Số điện lực thô | 45,960 kW |
| Vị trí không tổn hao (Tiểu đoàn 18) | 4,020 kW |
| Số sử dụng sau trừ (A) | 41,940 kW |
| Tổng công tơ có tổn hao (B) | 40,188 kW |
...
7. **Vị trí không tổn hao**: công tơ đặt tại trạm biến áp (không có đường dây) → tổn hao = 0, không tham gia mẫu số phân bổ tổn hao. Engine cần trừ các công tơ này khỏi tổng trước khi tính tổn hao.
